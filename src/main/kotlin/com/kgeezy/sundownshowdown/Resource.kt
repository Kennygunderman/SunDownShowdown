...
object StringRes {
    ...
    val SHOWDOWN_MOB_SPAWN_ADDED = PREFIX + ChatColor.GREEN + "Spawn point added for %1\$s!"
    ...
    val SHOWDOWN_MOB_ADD_USAGE = ChatColor.RED.toString() + "Usages: /showdown mob add <name>"
    val SHOWDOWN_MOB_REMOVE_USAGE = ChatColor.RED.toString() + "Usages: /showdown mob remove all"
    val SHOWDOWN_MOB_SPAWN_USAGE = ChatColor.RED.toString() + "Usages: /showdown mob spawn <all | chest | points>"
